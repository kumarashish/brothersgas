...
public class Common {
    ...
    public static String Customer_Address = "O_ADDR";
    public static String Product_Item = "O_ITEM";
    public static String Deposit_Amount = "O_DEPCHRGS";
    public static String Connection_charges = "O_CONCHRGS";
    public static String Disconnection_Charges = "O_DISCHRGS";
    public static String Pressure_Factor = "O_PFACT";
