...
/**
 * Created by ashish.kumar on 18-03-2019.
 */

public class Connection_Disconnection_Invoice_Preview_Model {
...
ArrayList<BillDetails> details_list=new ArrayList<>();
    ...
    public Connection_Disconnection_Invoice_Preview_Model(String value)
    {
        try{
    ...
    public ArrayList<BillDetails> getDetails_list()
{
    ...
    public class BillDetails{
        ...
        public  String Vat_percentage = "O_RATE";
        public  String VatAmount = "O_RATEAMT";
        ...
        public  String Vat_percentageValue;
        ...
        public BillDetails(JSONArray jsonArray) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    } else if (jsonObject.getString("NAME").equalsIgnoreCase(Vat_percentage)) {
                        Vat_percentageValue = jsonObject.isNull("content") ? "" : jsonObject.getString("content");
                    } else if (jsonObject.getString("NAME").equalsIgnoreCase(VatAmount)) {
                        VatAmountValue = jsonObject.isNull("content") ? "" : jsonObject.getString("content");
                    }
                }
            } catch (Exception ex) {
                ex.fillInStackTrace();
        ...
        public String getVat_percentageValue() {
            return Vat_percentageValue;
        }
