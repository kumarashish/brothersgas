...
public class NewContract extends Activity implements View.OnClickListener {
...
TextView heading;
    ...
    @BindView(R.id.intialreading)
    TextView initalMeterReading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initalMeterReading.setText("Intial Meter Reading : ");
    ...
    public void requestPermissionForReadExtertalStorage() throws Exception {
        try {
            ActivityCompat.requestPermissions(NewContract.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                    22);
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
    ...
    public void requestPermissionForCamera() throws Exception {
        try {
            ActivityCompat.requestPermissions(NewContract.this, new String[]{Manifest.permission.CAMERA},
                    21);
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
    ...
    public boolean isEmidValidated() {
        if ((em_id1.getText().length() == 3) && (em_id2.getText().length() == 4) && (em_id3.getText().length() == 7) && (em_id4.getText().length() == 1)) {
            ...
            em_id1.requestFocus();
            Toast.makeText(NewContract.this, "Please enter emirates Id", Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    public boolean isFieldsValidated() {
        if ((current_reading.getText().length() > 0) && (expiry_date.getText().length() > 0) && (isEmidValidated()) && (address.getText().length() > 0) && (contact_number.getText().length() > 0) && (emailId.getText().length() > 0)) {
            if (Utils.isValidEmailId(emailId.getText().toString())) {
                ...
                Toast.makeText(NewContract.this, "Please enter valid email id", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (current_reading.getText().length() == 0) {
                Toast.makeText(NewContract.this, "Please enter initial meter reading", Toast.LENGTH_SHORT).show();
            } else if (expiry_date.getText().length() == 0) {
                Toast.makeText(NewContract.this, "Please enter expiry date", Toast.LENGTH_SHORT).show();
            } else if (address.getText().length() == 0) {
                Toast.makeText(NewContract.this, "Please enter address", Toast.LENGTH_SHORT).show();
            } else if (contact_number.getText().length() == 0) {
                Toast.makeText(NewContract.this, "Please enter contact number", Toast.LENGTH_SHORT).show();
            } else if (emailId.getText().length() == 0) {
                Toast.makeText(NewContract.this, "Please enter email id", Toast.LENGTH_SHORT).show();
            }
        }
        return false;
    }
