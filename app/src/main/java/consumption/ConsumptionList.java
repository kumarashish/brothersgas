...
public class ConsumptionList   extends Activity implements View.OnClickListener , ListItemClickListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading.setText("Contract List");
        back.setOnClickListener(this);
        if(Utils.isNetworkAvailable(ConsumptionList.this)) {
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.search:
                ...
                Intent in=new Intent(ConsumptionList.this,Search.class);
    ...
    public void onClick(final ContractModel model) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Intent in=new Intent(ConsumptionList.this, ConsumptionDetails.class);
    ...
    public class GetData extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.length() > 0) {
                ...
                Toast.makeText(ConsumptionList.this, "Data not found", Toast.LENGTH_SHORT).show();
            }
